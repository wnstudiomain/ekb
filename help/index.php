...
$APPLICATION->SetPageProperty("description", "Доставка товаров интернет-магазина Restoranica осуществляется по Екатеринбургу, Кургану, Воронежу и прочим городам РФ. Оплата производится наличными курьеру или безналичным расчетом.");
$APPLICATION->SetPageProperty("keywords", "Доставка Restoranica, оплата Restoranica");
$APPLICATION->SetPageProperty("title", "Доставка и оплата - Restoranica");
