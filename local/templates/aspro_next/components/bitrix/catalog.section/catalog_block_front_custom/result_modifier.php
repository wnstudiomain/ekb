...
if (!empty($arResult['ITEMS'])){
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		if(is_array($arItem['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE']))
		{
			$arItem['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'] = reset($arItem['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE']);
			$arResult['ITEMS'][$key]['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'] = $arItem['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'];
			if($arItem['DISPLAY_PROPERTIES']['MINIMAL_COUNT_GOODS'])
			{
				$arItem['DISPLAY_PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'] = reset($arItem['DISPLAY_PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE']);
				$arResult['ITEMS'][$key]['DISPLAY_PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'] = $arItem['DISPLAY_PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'];
			}
		}
