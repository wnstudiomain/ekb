...
if($arResult['ITEMS']){?>
	...
	<span id="<?=$injectId?>_items" class="bigdata_recommended_products_items loading_state shadow border custom_flex top_right">
	<div class="swiper-container bigdata_recommended-swiper">
	<ul class="swiper-wrapper tabs_slider RECOMENDATION_slides slides catalog_block">
			<?foreach ($arResult['ITEMS'] as $key => $arItem){?>
				<?$strMainID = $this->GetEditAreaId($arItem['ID'] . $key);?>
				<li class="swiper-slide catalog_item visible" id="<?=$strMainID;?>">
					<?
			...
			<ul class="slider_navigation top custom_flex border">
									<li class="tabs_slider_navigation RECOMENDATION_nav cur" data-code="RECOMENDATION"><ul class="flex-direction-nav"><li class="flex-nav-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-77f4fc1065a647f17" aria-disabled="true"><a class="flex-prev" href="#">Previous</a></li><li class="flex-nav-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-77f4fc1065a647f17" aria-disabled="false"><a class="flex-next" href="#">Next</a></li></ul></li>
												</ul>
	</span>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var swiper = new Swiper('.bigdata_recommended-swiper', {
				slidesPerView: 1.7,
						freeMode: true,
						breakpoints: {
							640: {
