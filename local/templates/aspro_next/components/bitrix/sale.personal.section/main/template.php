...
<div class="personal_wrapper">
	<div class="row sale-personal-section-row-flex">
		...
		<?if ($groupID == 11):?>
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b-20">
			<div class="sale-personal-section-index-block sale-discount-block gold-discount">
				<span class="sale-personal-section-index-block-link">
					<p>GOLD</p>
					<h2 class="sale-personal-section-index-block-name">
						Ваша персональная скидка <span>10%</span>
					</h2>
				</span>
			</div>
		</div>
		<?elseif ($groupID == 9):?>
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b-20">
			<div class="sale-personal-section-index-block sale-discount-block standart-discount">
				<span class="sale-personal-section-index-block-link">
					<p>STANDART</p>
					<h2 class="sale-personal-section-index-block-name">
						Ваша персональная скидка <span>5%</span>
					</h2>
				</span>
			</div>
		</div>
		<?elseif ($groupID == 12):?>
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b-20">
			<div class="sale-personal-section-index-block sale-discount-block platinum-discount">
				<span class="sale-personal-section-index-block-link">
					<p>PLATINUM</p>
					<h2 class="sale-personal-section-index-block-name">
						Ваша персональная скидка <span>15%</span>
					</h2>
				</span>
			</div>
		</div>
