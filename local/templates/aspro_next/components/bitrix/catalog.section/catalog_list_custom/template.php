		...
		<?foreach($arResult["ITEMS"] as $arItem){?>
			...
			if(!$arItem["OFFERS"] || $arParams['TYPE_SKU'] !== 'TYPE_1'){
				...
				if(!$arItem['PROPERTIES']['WEIGHTED_GOODS']['~VALUE']):
					...
					$arAddToBasketData = \Aspro\Functions\CAsproNextCustom::GetAddToBasketArray($arItem, $totalCount, $arParams["DEFAULT_COUNT"], $arParams["BASKET_URL"], false, $arItemIDs["ALL_ITEM_IDS"], 'small', $arParams, $minimalCountGoods);
				endif;
