...
$('.basket-item-block-amount').appendTo('.basket-item-block-info')
...
CheckHeaderFixed = function(){
	...
	if(mfixed.length && window.matchMedia('(min-width:767px) and (max-width: 992px)').matches)
	{
...
$(document).ready(function(){
	...
	if($mobileMenu.length){
		...
		$('#mobilemenu .menu a').click(function(e){
			var $this = $(this)
			console.log('123')
	...
	$("td.dropdown .dropdown-toggle").click(function (e) {
		e.preventDefault();
		e.stopPropagation();
		//$('.overlay-header').toggleClass('visible')
		$(this).siblings('.dropdown-menu').toggleClass('visible')
		$(this).toggleClass('visible')
	})
	$(window).on('click', function(){
		if ($('.dropdown-menu').hasClass('visible') && $(this).not('.more_items')) {
			$('.dropdown-menu').removeClass('visible')
			$('.dropdown-toggle').removeClass('visible')
		}
	});
	...
	$('.tabs>li').on('click', function(){
		...
		if(!$(this).hasClass('active')){
			...
			if(parent.hasClass('ajax')) // front tabs
			{
				...
				{
					$.ajax({
						url: arNextOptions['SITE_DIR'] + 'include/mainpage/comp_catalog_ajax_custom.php',
						type: 'POST',
