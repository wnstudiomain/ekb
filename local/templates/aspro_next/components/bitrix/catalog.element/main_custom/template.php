...
if($arResult["OFFERS"]){
    ...
    $minimalCountGoods = $arResult['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'];
    if(!$arResult['PROPERTIES']['WEIGHTED_GOODS']['~VALUE']):
      ...
      $arAddToBasketData = \Aspro\Functions\CAsproNextCustom::GetAddToBasketArray($arResult, $totalCount, $arParams["DEFAULT_COUNT"], $arParams["BASKET_URL"], false, $arItemIDs["ALL_ITEM_IDS"], 'btn-lg w_icons', $arParams, $minimalCountGoods);
    endif;
...
<div class="item_main_info <?=(!$showCustomOffer ? "noffer" : "");?> <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?>"
        ...
        <div class="item_slider">
            ...
            <div class="like_wrapper">
                ...
                <div class="like_icons iblock">
                    ...
                    <div class="wish_item text " <?=($arAddToBasketData['CAN_BUY'] ? '' : 'style="display:none"');?>
                        data-item="" data-iblock="<?=$arResult["IBLOCK_ID"]?>"
                        <?=(!empty($arResult['OFFERS_PROP']) ? 'data-offers="Y"' : '');?>
                    ...
                    <div data-item="" data-iblock="<?=$arResult["IBLOCK_ID"]?>"
                        data-href="<?=$arResult["COMPARE_URL"]?>" class="compare_item text <?=$arParams["TYPE_SKU"];?>">
                        <span class="value" title="<?=GetMessage('CT_BCE_CATALOG_COMPARE')?>"><i></i></span>
                        <span class="value added" title="<?=GetMessage('CT_BCE_CATALOG_COMPARE_ADDED')?>"><i></i></span>
                    </div>
                    <?endif;?>
            ...
            <div class="slides">
                ...
                $title=$arFirstPhoto["TITLE"];?>
                    ...
                    <a href="<?=($viewImgType=="POPUP" ? $arFirstPhoto["BIG"]["src"] : "javascript:void(0)");?>"
                        ...
                        src="<?=$arFirstPhoto['SMALL']['src']; ?>"
                        <?=($viewImgType=="MAGNIFIER" ? 'data-large="" xpreview="" xoriginal=""': "");?>
                        alt="<?=$alt;?>" title="<?=$title;?>" itemprop="image">
                        <div class="zoom"></div>
                    </a>
                    <?}else{?>
                    <a href="javascript:void(0)" class="" title="<?=$title;?>">
                        <img id="<? echo $arItemIDs[" ALL_ITEM_IDS"]['PICT']; ?>" src="<?=$arFirstPhoto['SRC']; ?>"
                        alt="<?=$alt;?>" title="<?=$title;?>" itemprop="image">
                        <div class="zoom"></div>
                    </a>
                    <?}?>
            ...
            if($arResult["MORE_PHOTO"]){
                ...
                <ul>
                    ...
                    <li id="photo-<?=$i?>" <?=(!$i ? 'class="current"' : 'style="display: none;"')?>>
                        <?if(!$isEmpty){?>
                        <a href="<?=($viewImgType=="POPUP" ? $arImage["BIG"]["src"] : "javascript:void(0)");?>"
                            <?=($bIsOneImage ? '' : 'data-fancybox-group="item_slider"')?>
                            class="<?=($viewImgType=="POPUP" ? "popup_link fancy" : "line_link");?>"
                            title="<?=$title;?>">
                            <img src="<?=$arImage["SMALL"]["src"]?>"
                                <?=($viewImgType=="MAGNIFIER" ? "class='zoom_picture'" : "");?>
                                <?=($viewImgType=="MAGNIFIER" ? 'xoriginal="'.$arImage["BIG"]["src"].'" xpreview="'.$arImage["THUMB"]["src"].'"' : "");?>
                ...
                <div class="thumbs flexslider"
                    ...
                    <ul class="slides_block" id="thumbs">
                        ...
                        <li <?=(!$i ? 'class="current"' : '')?> data-big_img="<?=$arImage["BIG"]["src"]?>"
                            ...
                            <span><img class="xzoom-gallery" width="50" xpreview="<?=$arImage["THUMB"]["src"];?>"
                ...
                $(document).ready(function () {
                    ...
                    $('.item_slider .thumbs .slides_block').delegate('li:not(.current)', 'click', function () {
                        ...
                        $(this).addClass('current').siblings().removeClass(
                            'current') //.parents('.item_slider').find('.slides li').fadeOut(333);
                        if (arNextOptions['THEME']['DETAIL_PICTURE_MODE'] == 'MAGNIFIER') {
                            ...
                            slider_wrapper.find('.slides li:eq(' + index + ')').addClass('current')
                                .show();
                        }
                    });
                })
    ...
    <div class="right_info">
                ...
                $component, array("HIDE_ICONS" =>"Y")
                    ...
                    <div class="item_block col-<?=$col;?>">
                        <div class="article iblock" itemprop="additionalProperty" itemscope
                            itemtype="http://schema.org/PropertyValue" <?if($arResult['SHOW_OFFERS_PROPS']){?>id="
                            <? echo $arItemIDs["ALL_ITEM_IDS"]['DISPLAY_PROP_ARTICLE_DIV'] ?>" style="display: none;"
                            <?}?>>
                            <span class="block_title"
                                itemprop="name"><?=$arResult["DISPLAY_PROPERTIES"]["CML2_ARTICLE"]["NAME"];?>:</span>
                            <span class="value"
                    ...
                    <div class="item_block col-<?=$col;?>">
                        <div class="brand">
                            ...
                            <a
                                href="<?=$arResult["BRAND_ITEM"]["DETAIL_PAGE_URL"]?>"><?=$arResult["BRAND_ITEM"]["NAME"]?></a>
                            <?else:?>
            ...
            <div class="middle_info main_item_wrapper">
                ...
                <div class="prices_block">
                    <div class="cost prices clearfix">
                        ...
                        <?if($arResult['PROPERTIES']['WEIGHTED_GOODS']['~VALUE']):?>
                        <?$minQuantity = $arResult['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'];?>
                        <?else:?>
                        <?$minQuantity = 1 ?>
                        <?endif;?>
        ...
        if(isset($arResult['PRICE_MATRIX']) && $arResult['PRICE_MATRIX']) // USE_PRICE_COUNT
        {
            if($arResult['PRICE_MATRIX']['COLS'])
            {
                ...
                $min_price_id = $arCurPriceType['ID'];?>
                        ...
                        <?else:?>
                        <?$strMeasureCustom = $arResult['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'].' '.$strMeasure;?>
                        <?=\Aspro\Functions\CAsproNextCustom::showPriceMatrix($arResult, $arParams, $strMeasureCustom, $arAddToBasketData, $minimalCountGoods);?>
                        <?endif;?>
                        <?
        }
        else
        {?>
                        <?if($arResult['PROPERTIES']['WEIGHTED_GOODS']['~VALUE']):?>
                        <?$strMeasureCustomNew = $arResult['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'];?>
                        <?$old_price =  $arResult['MIN_PRICE']['VALUE'] * $strMeasureCustomNew; ?>
                        <?$new_price = ($arResult['MIN_PRICE']['DISCOUNT_VALUE'] ? $arResult['MIN_PRICE']['DISCOUNT_VALUE'] : $arResult['MIN_PRICE']['VALUE']) * $strMeasureCustomNew;?>
                        <?$format_new_price = \CCurrencyLang::CurrencyFormat($new_price, $arResult['MIN_PRICE']['CURRENCY'], true); ?>
                        <?$format_old_price = \CCurrencyLang::CurrencyFormat($old_price, $arResult['MIN_PRICE']['CURRENCY'], true); ?>
                        <div class="price" data-currency="<?=$arResult['MIN_PRICE']['CURRENCY']?>"
                            data-value="<?=($arResult['MIN_PRICE']['DISCOUNT_VALUE'] ? $arResult['MIN_PRICE']['DISCOUNT_VALUE'] : $arResult['MIN_PRICE']['VALUE'])?>">
                            ...
                            <div>
                                ...
                                <div class="old-price">
                                    ...
                                    <span class="price_measure">/<?=$strMeasureCustomNew?> <?=$strMeasure?> </span>
                        ...
                        <?$format_price = \CCurrencyLang::CurrencyFormat($price, $arResult['MIN_PRICE']['CURRENCY'], true); ?>
                        <?$format_old_price = \CCurrencyLang::CurrencyFormat($old_price, $arResult['MIN_PRICE']['CURRENCY'], true); ?>
                        <div class="price" data-currency="<?=$arResult['MIN_PRICE']['CURRENCY']?>"
                            data-value="<?=($arResult['MIN_PRICE']['DISCOUNT_VALUE'] ? $arResult['MIN_PRICE']['DISCOUNT_VALUE'] : $arResult['MIN_PRICE']['VALUE'])?>">
                            <?if($arResult['MIN_PRICE']['DISCOUNT_VALUE'] != $arResult['MIN_PRICE']['VALUE']):?>
                            <div>
                                ...
                                <div class="new-price">
                                    <span class="price_value"><?=$format_price?></span>
                                    <span class="price_measure">/<?=$strMeasure?></span>
                                </div>
                            </div>
                            <?else:?>
        ...
        if($arDiscount["ACTIVE_TO"]){?>
                    ...
                    <div class="quantity_block">
                        ...
                        <div class="values">
                            <span class="item">
                                <span class="value"
                                    <?=((count( $arResult["OFFERS"] ) > 0 && $arParams["TYPE_SKU"] == 'TYPE_1' && $arResult["OFFERS_PROP"]) ? 'style="opacity:0;"' : '')?>><?=$totalCount;?></span>
                ...
                <?if($arResult['JS_OFFERS'])
        {
            ...
            foreach($arResult['JS_OFFERS'] as $keyOffer => $arTmpOffer2)
            {
                ...
                <? $_cls = 'cnt0';?>
                <?endif;?>
                <div class="quantity_block_wrapper  <?=$_cls?>">
                    <?if($useStores){?>
                    <div class="p_block <?=$_cls?>">
                        <?}?>
                        <?=$arQuantityData["TEXT"];?>
                        <?if($useStores){?>
                    </div>
            ...
            echo str_replace('#ITEM#_prop_', $arItemIDs["ALL_ITEM_IDS"]['PROP'], $strTemplate);
                    ...
                    <script type="text/javascript">
                        var < ? echo $arItemIDs["strObName"]; ? > = new JCCatalogElement( < ? echo CUtil::PhpToJSObject(
                            $arItemJSParams, false, true); ? > );
                    </script>
                </div>
                <?}?>
                <?if(!$arResult["OFFERS"]):?>
                ...
                <div class="counter_wrapp">
                    ...
                    <div class="counter_block big_basket" data-offers="<?=($arResult["OFFERS"] ? "Y" : "N");?>"
                        ...
                        <?=(($arResult["OFFERS"] && $arParams["TYPE_SKU"]=="N") ? "style='display: none;'" : "");?>>
                        <?if(!$arResult['PROPERTIES']['WEIGHTED_GOODS']['~VALUE']):?>
                        <span class="disable minus minus-button" id="<? echo $arItemIDs["
                            ALL_ITEM_IDS"]['QUANTITY_DOWN']; ?>">-</span>
                        <?else:?>
                        <span class="disable minus-weight minus-button" id="<? echo $arItemIDs["
                            ALL_ITEM_IDS"]['QUANTITY_DOWN']; ?>">-</span>
                        <?endif;?>
                        <input type="text" class="text" id="<? echo $arItemIDs[" ALL_ITEM_IDS"]['QUANTITY']; ?>" name="
                    ...
                    <div id="<? echo $arItemIDs[" ALL_ITEM_IDS"]['BASKET_ACTIONS']; ?>" class="button_block
                        <?=(($arAddToBasketData["ACTION"] == "ORDER" /*&& !$arResult["CAN_BUY"]*/) || !$arAddToBasketData["CAN_BUY"] || !$arAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_DETAIL"] || ($arAddToBasketData["ACTION"] == "SUBSCRIBE" && $arResult["CATALOG_SUBSCRIBE"] == "Y")  ? "wide" : "");?>">
                        <!--noindex-->
    ...
    {?>
            ...
            "ID" => $arItemIDs["strMainID"],
                ...
                <script type="text/javascript">
                    var < ? echo $arItemIDs["strObName"]; ? > el = new JCCatalogOnlyElement( < ? echo CUtil::
                        PhpToJSObject($arOnlyItemJSParams, false, true); ? > );
                </script>
                <?endif;?>
                <?}?>
                ...
                <div class="wrapp_one_click">
                    <span class="btn btn-default white btn-lg type_block transition_bg one_click"
                        data-item="<?=$arResult["ID"]?>" data-iblockID="<?=$arParams["IBLOCK_ID"]?>"
                ...
                <?elseif($arResult["OFFERS"] && $arParams['TYPE_SKU'] != 'TYPE_1'):?>
                <span
                    class="btn btn-default btn-lg slide_offer transition_bg type_block"><i></i><span><?=\Bitrix\Main\Config\Option::get("aspro.next", "EXPRESSION_READ_MORE_OFFERS_DEFAULT", GetMessage("MORE_TEXT_BOTTOM"));?></span></span>
                <?endif;?>
            </div>
            <?$frame->end();?>
        ...
        $location = ($bxCRequest->getCookieRaw('current_location')) ? $bxCRequest->getCookieRaw('current_location') : 2201 ;?>
            <?
        ...
        function getDeliveryPriceForProduct($bitrixProductId, $siteId, $userId, $personTypeId, $deliveryId, $userCityId, $deliveryType)
        {
            ...
            $weight = $arDelivery -> getDeliveryPrice();
            ...
            <div class="stock_wrapper">
                ...
                <div class="stock_board <?=($arStockItem["PREVIEW_TEXT"] ? '' : 'nt');?>">
                    <div class="title"><a class="dark_link"
                            href="<?=$arStockItem["DETAIL_PAGE_URL"]?>"><?=$arStockItem["NAME"];?></a></div>
                    <div class="txt"><?=$arStockItem["PREVIEW_TEXT"]?></div>
                </div>
                <?endforeach;?>
            </div>
            <?endif;?>
            <?if($arResult['PROPERTIES']['DISCOUNT']['VALUE_XML_ID'] == 'Y'):?>
            <div class="discount-block-wrapper" id="discount-block__button">
                <div class="discount-block">
                    <img src="/local/templates/aspro_next/images/svg/stock.svg" />
                    <div class="discount-block__wrapper">
                        <p class="discount-block__title">Этот товар можно купить дешевле</p>
                        <p>Узнать, какие скидки и акции действуют в этом месяце для данного товара
                             </p>
                    </div>
                </div>
                <div class="discount-descp">
                    <div class="discount-descp__arrow">
                    </div>
                    <div class="discount-descp__wrapper">
                        <div>
                            <?=htmlspecialcharsBack($arResult['PROPERTIES']['DISCOUNT_DESCP']['VALUE']['TEXT']);?>
                        </div>
                        <div class="additional-price-table">

                            <?$iCountPriceInterval = count($arResult["ITEM_PRICES"]);?>
                            <?$strMeasureCustom = $arResult['PROPERTIES']['MINIMAL_COUNT_GOODS']['VALUE'];?>
                            <?if($iCountPriceInterval > 1):?>
                                <span>Возможна Скидка за объем заказа:</span>
                            <div class="additional-price">
                                <?foreach($arResult["ITEM_PRICES"] as $key => $arPrice):?>
                                <?if($key < 1) {
                                        continue;
                                    }?>
                                <?$weight_price =  $arPrice['PRICE'] * $strMeasureCustom;?>
                                <?$format_weight_price = \CCurrencyLang::CurrencyFormat($weight_price, $arResult['MIN_PRICE']['CURRENCY'], true); ?>
                                <div class="price-block">
                                    <div class="price_interval">
                                        <?
										$quantity_from = $arPrice['QUANTITY_FROM'];
										$quantity_to = $arPrice['QUANTITY_TO'];
										$text = ('от '.$quantity_from );
										?>
                                        <?=$text?>
                                        <?if(($arParams["SHOW_MEASURE"]=="Y") && $strMeasure):?> <?=$strMeasure?>
                                        <?endif;?>
                                    </div>
                                    <?if($arResult['PROPERTIES']['WEIGHTED_GOODS']['~VALUE']):?>
                                    <div><?=$format_weight_price?>/<?=$strMeasureCustom?> <?=$strMeasure?></div>
                                    <?else:?>
                                    <div><?=$arPrice["PRINT_PRICE"]?></div>
                                    <?endif;?>
                                </div>
                                <?endforeach;?>
                            </div>
            ...
            <div class="delivery-block">
                ...
                <div class="">
                    <div class="city-delivery__block">
                        <div>
                            <p>в <span id="city_name"><?=$cityName?></span><a data-id-product="<?=$arResult["ID"]?>"
                                                                              id="city_change">Изменить</a></p>
                        </div>
                    </div>
                    <div class="delivery-wrapper delivery-calc">
                        <?if ($location != 2201 && $deliveryPriceForProductCourier["PRICE"] > 0):?>
                            <div id="courier-block">
                                <img class="courier" src="/local/templates/aspro_next/images/svg/delivery-truck.svg" />
                                <div class="delivery-wrapper__description">
                                    <div id="courier-block__title"><?=$deliveryPriceForProductCourier["TITLE"]?></div>
                                    <div class="courier-block__descp">
                                        <div class="courier-block__calc">
                                        <span
                                                id="courier-block__period"><?=$deliveryPriceForProductCourier["PERIOD"]?></span>,
                                            <span
                                                    id="courier-block__price"><?=round($deliveryPriceForProductCourier["PRICE"], -1)?>
                                        </span>
                        ...
                        <?elseif ($location != 2201 && $deliveryPriceForProductCourier["PRICE"] < 0):?>
                            <div id="courier-block">
                                <img class="courier" src="/local/templates/aspro_next/images/svg/delivery-truck.svg" />
                                <div class="delivery-wrapper__description">
                                    <div id="courier-block__title"><?=$deliveryPriceForProductCourier["TITLE"]?></div>
                        ...
                        <?elseif ($location==2201):?>
                            <div class="pickpoint__wrapper" id="courier-block">
                                <img class="courier" src="/local/templates/aspro_next/images/svg/delivery-truck.svg" />
                                <div class="delivery-wrapper__description">
                        ...
                        <?endif;?>
                        <?if ($deliveryPriceForProduct["PRICE"] > 0):?>
                            <div id="pickpoint-block">
                                <img class="pickpoint" src="/local/templates/aspro_next/images/svg/delivery-box.svg" />
                                <div class="delivery-wrapper__description">
                                    <div id="pickpoint-block__title"><?=$deliveryPriceForProduct["TITLE"]?></div>
                                    <div class="pickpoint-block__descp">
                                        <div class="pickpoint-block__calc">
                                        <span
                                                id="pickpoint-block__period"><?=$deliveryPriceForProduct["PERIOD"]?></span>,
                                            <span
                                                    id="pickpoint-block__price"><?=round($deliveryPriceForProduct["PRICE"], -1)?></span>
                                            <span id="rub">руб.</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?if ($location==2201):?>
                        <div class="delivery-wrapper ekb-delivery">
                            <div>
                                <img class="pickpoint" src="/local/templates/aspro_next/images/svg/store.svg" />
                                <div class="delivery-wrapper__description">
                                    <div>Самовывоз со склада</div>
                                    <div>Бесплатно, г. Екатеринбург, ул. Красных командиров 16</div>
                                </div>
                            </div>
                        </div>
                    <?endif;?>
                ...
                <div class="delivery-wrapper">
                    <div class="pay-wrapper">
                        <img src="/local/templates/aspro_next/images/svg/payment.svg" />
                        <div class="delivery-wrapper__description">
                            <div>Оплата</div>
                            <div>Безопасные способы оплаты: наличные, банковской картой, онлайн оплата картой на сайте, безналичный расчет</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="inner_wrapper item">
                ...
                <div class="img">
                    ...
                    <a href="<?=$arItem["UF_LINK"];?>"
                        <?=(strpos($arItem["UF_LINK"], "http") !== false ? "target='_blank' rel='nofollow'" : '')?>>
                        <?}?>
                        <img src="<?=$arItem["PREVIEW_PICTURE"]["src"];?>" alt="<?=$arItem["UF_NAME"];?>"
                            title="<?=$arItem["UF_NAME"];?>">
                        <?if($arItem["UF_LINK"]){?>
                    </a>
                    <?}?>
                </div>
            ...
            <div class="item_inner">
                <div class="image">
                    <a href="<?=$arSetItem["DETAIL_PAGE_URL"]?>">
                        ...
                        <img src="<?=$img["src"]?>" alt="<?=$arSetItem["NAME"];?>" title="<?=$arSetItem["NAME"];?>" />
                        <?else:?>
                        <img src="<?=SITE_TEMPLATE_PATH?>/images/no_photo_small.png" alt="<?=$arSetItem["NAME"];?>"
                ...
                <div class="item_info">
                    ...
                    <div class="cost prices clearfix">
                        ...
                        <div class="price">
                            ...
                            <?if(($arParams["SHOW_MEASURE"] == "Y") && $strMeasure):?><small>/<?=$strMeasure?></small>
                            <?endif;?>
                        </div>
...
?>
            <div class="tabs">
                <ul class="nav nav-tabs" data-clicked="no">
                    <?$iTab = 0;?>
                    <?$instr_prop = ($arParams["DETAIL_DOCS_PROP"] ? $arParams["DETAIL_DOCS_PROP"] : "INSTRUCTIONS");?>
                    <?if($arResult["OFFERS"] && $arParams["TYPE_SKU"]=="N"):?>
                    <li class="prices_tab<?=(!($iTab++) ? ' active' : '')?>" data-clicked="no">
                        <a
                            href="#prices_offer"><span><?=($arParams["TAB_OFFERS_NAME"] ? $arParams["TAB_OFFERS_NAME"] : GetMessage("OFFER_PRICES"));?></span></a>
                    </li>
                    <?endif;?>
                    ...
                    <li class="<?=(!($iTab++) ? '' : '')?>">
                        <a
                            href="#descr"><span><?=($arParams["TAB_DESCR_NAME"] ? $arParams["TAB_DESCR_NAME"] : GetMessage("DESCRIPTION_TAB"));?></span></a>
                    </li>
                    <?endif;?>
                    <?if($arParams["PROPERTIES_DISPLAY_LOCATION"] == "TAB" && $showProps):?>
                    <li class="<?=(!($iTab++) ? ' active' : '')?>">
                        <a
                            href="#props"><span><?=($arParams["TAB_CHAR_NAME"] ? $arParams["TAB_CHAR_NAME"] : GetMessage("PROPERTIES_TAB"));?></span></a>
                    </li>
                    <?endif;?>
                    <?if($arVideo):?>
                    <li class="<?=(!($iTab++) ? ' active' : '')?>">
                    ...
                    <li class="product_ask_tab <?=(!($iTab++) ? ' active' : '')?>">
                        <a
                            href="#ask"><span><?=($arParams["TAB_FAQ_NAME"] ? $arParams["TAB_FAQ_NAME"] : GetMessage('ASK_TAB'))?></span></a>
                    </li>
                    <?endif;?>
                    <?if($useStores && ($showCustomOffer || !$arResult["OFFERS"] )):?>
                    <li class="stores_tab<?=(!($iTab++) ? ' active' : '')?>">
                        <a
                            href="#stores"><span><?=($arParams["TAB_STOCK_NAME"] ? $arParams["TAB_STOCK_NAME"] : GetMessage("STORES_TAB"));?></span></a>
                    </li>
                    <?endif;?>
                    <?if($arResult['PROPERTIES']['COOKING']['VALUE']):?>
                    <li class="<?=(!($iTab++) ? ' active' : '')?>">
                        <a href="#coocking"><span>Способ приготовления</span></a>
                    </li>
                    <?endif;?>
                    <?if($arResult['PROPERTIES']['RECIPES']['VALUE']):?>
                    <li class="<?=(!($iTab++) ? ' active' : '')?>">
                        <a href="#recipes"><span>Рецепты</span></a>
                    </li>
                    <?endif;?>
                    <?if($arResult['PROPERTIES']['TEH_CHAR']['VALUE']):?>
                        <li class="<?=(!($iTab++) ? ' active' : '')?>">
                    ...
                    <li class="<?=(!($iTab++) ? ' active' : '')?>">
                        <a
                            href="#dops"><span><?=($arParams["TAB_DOPS_NAME"] ? $arParams["TAB_DOPS_NAME"] : GetMessage("ADDITIONAL_TAB"));?></span></a>
                    </li>
                    <?endif;?>
                </ul>
...
if(((in_array('PREVIEW_PICTURE', $arParams['OFFERS_FIELD_CODE']) || in_array('DETAIL_PICTURE', $arParams['OFFERS_FIELD_CODE'])))){
    ...
    foreach ($arResult["SKU_PROPERTIES"] as $key => $arProp){?>
                                        <?if(!$arProp["IS_EMPTY"]):?>
                                        <td class="property">
                                            <div class="props_item char_name <?if($arProp[" HINT"] &&
                                                $arParams["SHOW_HINTS"]=="Y" ){?>whint
                                                <?}?>">
    ...
    if($arResult["OFFERS"]){
        ...
        {?>
            ...
            "ID" => $this->GetEditAreaId($arSKU["ID"]),
                                        ...
                                        <script type="text/javascript">
                                            var ob < ? echo $this - > GetEditAreaId($arSKU["ID"]); ? > el =
                                                new JCCatalogOnlyElement( < ? echo CUtil::PhpToJSObject(
                                                    $arOnlyItemJSParams, false, true); ? > );
                                        </script>
                                        <?}?>
                                        <td class="buy"
                                            <?=($arskuAddToBasketData["ACTION"] !== "ADD" || !$arskuAddToBasketData["CAN_BUY"] || $arParams["SHOW_ONE_CLICK_BUY"]=="N" ? 'colspan="3"' : "")?>>
                                        ...
                                        <td class="one_click_buy">
                                            <?$collspan++;?>
                                            <span class="btn btn-default white one_click" data-item="<?=$arSKU["ID"]?>"
                ...
                $component
                    ...
                    <div class="tab-pane" id="descr">
                        ...
                        <div>
                            ...
                            <div class="wraps">
                                <hr>
                                <h4><?=($arParams["TAB_CHAR_NAME"] ? $arParams["TAB_CHAR_NAME"] : GetMessage("PROPERTIES_TAB"));?>
                                </h4>
                                ...
                                <div class="props_block" id="<? echo $arItemIDs[" ALL_ITEM_IDS"]['DISPLAY_PROP_DIV']; ?>
                                    ...
                                    <div class="char" itemprop="additionalProperty" itemscope
                                        ...
                                        <div class="char_name">
                                            ...
                                            <?endif;?>
                                            <div class="props_item <?if($arProp[" HINT"] && $arParams["SHOW_HINTS"]=="Y"
                                                ){?>whint
                                                <?}?>">
                                ...
                                <div class="char_block">
                                    <table class="props_list">
                                        ...
                                        <tr itemprop="additionalProperty" itemscope
                                            ...
                                            <td class="char_name">
                                                ...
                                                <?endif;?>
                                                <div class="props_item <?if($arProp[" HINT"] &&
                                                    $arParams["SHOW_HINTS"]=="Y" ){?>whint
                                                    <?}?>">
                                                    <span itemprop="name"><?=$arProp["NAME"]?></span>
                                                </div>
                                    ...
                                    <table class="props_list" id="<? echo $arItemIDs["
                                        ALL_ITEM_IDS"]['DISPLAY_PROP_DIV']; ?>"></table>
                                </div>
                                <?endif;?>
                            </div>
                            <?endif;?>
    ...
    ?>
                            ...
                            <div class="wraps">
                                <hr>
                                <h4><?=($arParams["BLOCK_DOCS_NAME"] ? $arParams["BLOCK_DOCS_NAME"] : GetMessage("DOCUMENTS_TITLE"))?>
                                </h4>
                            ...
                            <div
                                class="wraps galerys-block with-padding<?=($arResult['OFFERS'] && 'TYPE_1' === $arParams['TYPE_SKU'] ? ' hidden' : '')?>">
                                <hr>
                                <h4><?=($arParams["BLOCK_ADDITIONAL_GALLERY_NAME"] ? $arParams["BLOCK_ADDITIONAL_GALLERY_NAME"] : GetMessage("ADDITIONAL_GALLERY_TITLE"))?>
                                </h4>
                                            ...
                                            <li class="col-md-3 item visible">
                                                <div>
                                                    <img src="<?=$arPhoto['PREVIEW']['src']?>"
                                                        class="img-responsive inline" title="<?=$arPhoto['TITLE']?>"
                                                        alt="<?=$arPhoto['ALT']?>" />
                                                </div>
                                                <a href="<?=$arPhoto['DETAIL']['SRC']?>"
                                                    class="fancy dark_block_animate" rel="gallery" target="_blank"
                                            ...
                                            <div class="flexslider big_slider dark bigs color-controls" id="slider"
                                                ...
                                                <ul class="slides items">
                                                    ...
                                                    <li class="col-md-12 item">
                                                        <a href="<?=$arPhoto['DETAIL']['SRC']?>" class="fancy"
                    ...
                    <div class="tab-pane id=" props">
                        ...
                        <div>
                            ...
                            <table class="props_list" id="<? echo $arItemIDs[" ALL_ITEM_IDS"]['DISPLAY_PROP_DIV']; ?>">
                            </table>
                            <?endif;?>
                        </div>
                    </div>
                            ...
                            <table class="video_table">
                                <tbody>
                                    ...
                                    <tr>
                                        <?endif;?>
                                        <td width="50%">
                                            <?=str_replace('src=', 'width="458" height="257" src=', str_replace(array('width', 'height'), array('data-width', 'data-height'), $value));?>
                                        </td>
                                        <?if(!(($v + 1) % 2)):?>
                                    </tr>
                                    <?endif;?>
                    ...
                    <div class="tab-pane" id="ask">
                        <div class="title-tab-heading visible-xs">
                            <?=($arParams["TAB_FAQ_NAME"] ? $arParams["TAB_FAQ_NAME"] : GetMessage('ASK_TAB'))?></div>
                        <div class="row">
                    ...
                    <div class="tab-pane stores_tab" id="stores">
                        <div class="title-tab-heading visible-xs">
                            <?=($arParams["TAB_STOCK_NAME"] ? $arParams["TAB_STOCK_NAME"] : GetMessage("STORES_TAB"));?>
                        </div>
            ...
            $component
                    ...
                    <?if($arResult['PROPERTIES']['COOKING']['VALUE']):?>
                    <hr>
                    <div class="tab-pane additional_block" id="coocking">
                        <h3 class="hidden-xs">Способ приготовления</h3>
                        <div class="title-tab-heading visible-xs">
                            Способ приготовления
                        </div>
                        <div>
                            <?=htmlspecialcharsBack($arResult['PROPERTIES']['COOKING']['VALUE']['TEXT']);?>
                        </div>
                    </div>
                    <?endif;?>
                    ...
                    <?if($arResult['PROPERTIES']['RECIPES']['VALUE']):?>
                    <hr>
                    <div class="tab-pane additional_block" id="recipes">
                        <h3 class="hidden-xs">Рецепты</h3>
                        <div class="title-tab-heading visible-xs">
                            Рецепты
                        </div>
                        <div>
                            <?=htmlspecialcharsBack($arResult['PROPERTIES']['RECIPES']['VALUE']['TEXT']);?>
                        </div>
                    </div>
                    <?endif;?>
                ...
                <?if($arResult['PROPERTIES']['TEH_CHAR']['VALUE']):?>
                    <hr>
                    <div class="tab-pane additional_block" id="recipes">
                        <h3 class="hidden-xs">Технические характеристики</h3>
                        <div class="title-tab-heading visible-xs">
                ...
                <?endif;?>
                    <?if($arParams["USE_REVIEW"] == "Y"):?>
                    <hr>
                    <div class="tab-pane review hidden-xs" id="review">
                        <div class="review-wrapper">
                            <h3 class="hidden-xs">
                                <?=($arParams["TAB_REVIEW_NAME"] ? $arParams["TAB_REVIEW_NAME"] : GetMessage("REVIEW_TAB"))?>
                            </h3>
                            <p>
                                Для нас очень важны комментарии, которые вы оставляете. Ведь они помогают другим
                                покупателям сделать правильный выбор, а нам дополнительно контролировать качество наших
                    ...
                    <?endif;?>
                    <?if($arParams["USE_REVIEW"] == "Y"):?>
                    <div class="tab-pane media_review product_reviews_tab visible-xs" id="mobile-review">
                        <div class="title-tab-heading visible-xs">
                            <?=($arParams["TAB_REVIEW_NAME"] ? $arParams["TAB_REVIEW_NAME"] : GetMessage("REVIEW_TAB"))?><span
                                class="count empty"></span>
                        </div>
                        <div class="review-descp">
                            <p>
                                Для нас очень важны комментарии, которые вы оставляете. Напишите, пожалуйста, свой
                                отзыв, критику, похвалу - мы обязательно прочитаем,
                                и учтем это в своей работе!
                            </p>
                            <?if(!$USER->IsAuthorized()):?>
                            <p>Для отправки комментария вам нужно  <a href="/auth/">авторизоваться</a>  или  <a
