			...
			<div class="similar_products_wrapp">
				<?if(!$IsViewedTypeLocal):?>
					...
					<?$APPLICATION->IncludeComponent(
						...
						"catalog_viewed_horizontal".strtolower($arTheme['VIEWED_TEMPLATE']['VALUE']),
						array(
				...
				<?else:?>
<?global $arTheme;
$arTheme['VIEWED_TEMPLATE']['VALUE'] = 'horizontal_custom';?>
					<?$APPLICATION->IncludeComponent(
	...
	array(
		"TITLE_BLOCK" => GetMessage("VIEWED_BEFORE"),
		"SHOW_MEASURE" => "Y",
		"COMPONENT_TEMPLATE" => "main_horizontal_custom",
		"IBLOCK_ID" => "17",
