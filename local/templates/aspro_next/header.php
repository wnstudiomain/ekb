...
<head>
	...
	Asset::getInstance()->addString('<script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>');
	...
	Asset::getInstance()->addCss('https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&display=swap');
	...
	<script>
		...
		})(window, document, 'script', 'dataLayer', 'GTM-KDBXZK8');
	</script>
	...
	<noscript>
		<div><img src="https://mc.yandex.ru/watch/70477468" style="position:absolute; left:-9999px;" alt="" /></div>
	</noscript>
	<!-- /Yandex.Metrika counter -->
</head>
...
<body class="<?= ($bIncludedModule ? "fill_bg_" . strtolower(CNext::GetFrontParametrValue("SHOW_BG_BLOCK")) : ""); ?>" id="main">
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KDBXZK8" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
	...
	<div class="wraps hover_<?= $arTheme["HOVER_TYPE_IMG"]["VALUE"]; ?>" id="content">
		...
		<? if ($isIndex) : ?>
			...
			<? elseif (!$isWidePage) : ?>
				...
				<? if (($APPLICATION->GetCurPage(false) !== '/') && ($isIndex && $isShowIndexLeftBlock) || (!$isIndex && !$isHideLeftBlock) && !$isBlog) : ?>
