...
$APPLICATION->SetPageProperty("description", "Интернет-магазин Restoranica готов предложить услуги: кофемашины и кофемолки в аренду, ремонт и сервисное обслуживание кофейного оборудования.");
$APPLICATION->SetPageProperty("keywords", "Услуги Restoranica");
$APPLICATION->SetPageProperty("title", "Услуги компании Restoranica");
